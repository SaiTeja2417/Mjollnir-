...
export default function HomeLayout({
  ...
  return (
    <>
        ...
        <div className="max-w-8xl mx-auto sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link onClick={() => { setActive('home') }} className={active == 'home' ? "text-primary text-xl " : "hover:text-red-500 text-xl font-semi-bold"} href={"/home/homepage"}>
                Home
              </Link>
      ...
      {/* Page Content */}
      <main className="min-h-screen antialiased bg-gradient-to-br from-blue-50 to-green-50 min-h-screen">{children}</main>
